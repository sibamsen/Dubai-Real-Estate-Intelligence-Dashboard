...
Bedroom vs Neighborhood – Shows total square footage contribution across different bedroom counts and localities.

Square Feet vs Price (Scatter Plot) – Visualizes the relationship between property size and pricing, segmented by category (Budget, Mid-Range, High-End).

Property Age Distribution – Displays how listings are distributed based on property age.

Listing Category by Neighborhood (Treemap) – Highlights the concentration of property types across different neighborhoods.

Filter Panel – Interactive slicers for:
